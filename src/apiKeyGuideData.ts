    ...
    tips: [
      {
        ...
        body: "Anthropic には無料枠がなく、モデル単価も3社で最も高めです。このアプリにはプロンプトキャッシュ設定 (なし / 5分 / 1時間) があり、あなたの返信テンポに合う時間を選ぶと、システムプロンプトと会話履歴の再送分が約 1/10 価格で読まれて、会話が長くなるほど効きます。ただしキャッシュへの書き込みは割増 (5分=1.25倍、1時間=2倍) のため、返信間隔が設定時間を超えがちな使い方では逆に割高になります — だから既定はオフにしてあり、あなたが明示的に選ぶ形です。テンポよく話すなら5分、ゆっくり話すなら1時間が目安。それでも日常使いのコストは Gemini や OpenAI より高くなりがちで、はじめての1本には Gemini をおすすめします。なお軽量な Haiku は安価ですが、パートナーとの会話用途では物足りなさが目立ちます。Claude を選ぶなら Sonnet 5 以上が現実的です。",
      },
    ],
    cautions: COMMON_CAUTIONS,
  },
